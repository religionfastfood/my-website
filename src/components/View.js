               ...
               <div class="row no-gutters slider-text align-items-center">
                         ...
                         <div class="col-lg">
                             <div class="mb-4">
                                    ...
                                    <Typewriter options={{ strings: ['developer.', '60% iced coffee by volume','all-around-creative.', 'cat dad.', 'local weirdo.'], autoStart: true, loop: true, deleteSpeed: 35}}/>
                             </div>
                             <p class="mb-4-p">
                                    Welcome to my personal website. Here you'll find a bit of everything I'm up to. The site is a work in progress. Please direct all criticisms to the site admin/tabby cat, Winston. 
                             </p>
